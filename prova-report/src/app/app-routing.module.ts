...
const routes: Routes = [
  ...
  { path: 'verificacion-defectos', canActivate: [AuthGuard], loadChildren: ()=> import('./pages/verificacion-defectos/verificacion-defectos.module').then(m => m.VerificacionDefectosModule)},
